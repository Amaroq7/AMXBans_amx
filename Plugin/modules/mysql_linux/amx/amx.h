...
#define AMX_FLAG_NONATCHK	0x100	/* do not check natives */
#define AMX_FLAG_NTVREG 0x1000  /* all native functions are registered */ // By AMXMODX Dev Team
...
#define UT_OPTIMIZER	2 // By AMXMODX Dev Team
#define UT_BROWSEHOOK	1 // By AMXMODX Dev Team

typedef void (*BROWSEHOOK)(AMX *amx, cell *oplist, cell *cip); // By AMXMODX Dev Team
